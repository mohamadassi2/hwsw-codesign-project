...
# ---------------------------------------------------------------- 3c. attribution
# Two claims in section 3 of the report are about the shape of the work rather
# than about wall-clock time, and both used to be asserted. Measure them:
#   table_stats.py  what the shipped linear scan actually costs on this input
