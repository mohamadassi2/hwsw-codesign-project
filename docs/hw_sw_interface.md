...
| Canonical-Huffman symbol decode (`find_next_symbol` + `snoopbits`/`readbits`) | **hardware** | 50.8% of the optimized run, cumulative; bit-serial work, one symbol per clock in hardware |
